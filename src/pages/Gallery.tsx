...
const Gallery = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title="SOLARQUENCH Project Gallery | Industrial & Residential Solar"
        description="Browse SOLARQUENCH solar installations across South Africa. View industrial, commercial, and residential projects engineered for maximum efficiency."
        keywords="solar gallery, solar installations south africa, industrial solar, residential solar projects"
        url="https://solarquench.com/gallery"
      />
      <Navbar />
